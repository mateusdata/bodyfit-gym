            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1
                        ...
                        Fazer login como adiministrador
                    </h1>
                    <form class="space-y-4 md:space-y-6" action="../../api/login.php" method="POST">
                        <div>
                            ...
                            <input type="text" id="email" name="email" required
                                ...
                                placeholder="mateus.administrador@data.com">
                        </div>
                        <div>
                            <label for="senha"
                        ...
                        <div>
                            <input name="tipo_user" type="text" class="bg-red-600 hidden"  value="adm" >
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            voce é aluno? <a href="/src/pages/loginForm.php"
