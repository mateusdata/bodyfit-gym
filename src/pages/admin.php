...
<body>
    ...
    <div>
        ...
        <a class="fixed top-[90%] w-20 left-[90%] text-white text-md hover:bg-blue-600 animate-pulse 
        bottom-0 bg-red-800 p-2 rounded-lg shadow-xl flex items-center justify-center
         h-10" href="../../src/pages/logout.php">Sair</a>
    </div>
