        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div class="space-y-6 lg:space-y-10">
                ...
                <div class="flex">
                    ...
                    <div class="ml-5 sm:ml-8">
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-400">
                            ...
                            Uma solução digital de ponta que permite criar, personalizar e gerenciar fichas de treino
                            sob medida para cada aluno, otimizando a experiência de treinamento e maximizando os
                            resultados.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-5 sm:ml-8">
                        <h3 class="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">
                            Cadastro de Modelos de Treinos Personalizados
                        </h3>
                        <p class="mt-1 text-gray-600 dark:text-gray-400">
                            Capacidade para o administrador cadastrar diversos modelos de treinos, adaptados às
                ...
                <div class="flex">
                    ...
                    <div class="ml-5 sm:ml-8">
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-400">
                            Facilidade em atribuir os modelos de treinos cadastrados aos alunos, garantindo uma
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Cadastro e
                                Gerenciamento

                            </h3>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400">Possibilidade de cadastrar múltiplas academias no
                        sistema, facilitando o controle e a organização.</p>
                </div>
                ...
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Centralização de
                                Informações
                ...
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Flexibilidade na
                                Personalização</h3>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400">Adaptação dos modelos de treinos de acordo com as
                        necessidades e objetivos individuais.</p>
                </div>
                ...
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Facilidade na
                                Organização:
                            </h3>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400">Estrutura intuitiva que auxilia na organização dos
                        treinos, agendamentos e atribuições. </p>
                </div>
                ...
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Treinos para
                                Resultados Reais</h3>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400">Do administrador ao aluno, o BodyFit entrega treinos
                        personalizados que impulsionam resultados verdadeiros.</p>
                </div>
                ...
                <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
                    <div class="flex items-center gap-x-4 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Transformação
                                Garantida
                            </h3>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400">com uma abordagem inteligente, o BodyFit simplifica o
                        gerenciamento de treinos e maximiza o potencial de cada aluno.</p>
                </div>
            </div>
        </div>
