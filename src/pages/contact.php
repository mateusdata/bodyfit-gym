...
<body>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl lg:max-w-5xl mx-auto">
                        ...
                        <div class="grid gap-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="hs-firstname-contacts-1" id="hs-firstname-contacts-1" class="py-3 px-4 block w-full border border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Primeiro Nome">
                                </div>

                                <div>
                                    <label for="hs-lastname-contacts-1" class="sr-only">Utimo Name</label>
                                    <input type="text" name="hs-lastname-contacts-1" id="hs-lastname-contacts-1" class="py-3 px-4 block w-full border border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="utimo Nome">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" autocomplete="email" class="py-3 px-4 block w-full border border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Email">
                            </div>

                            <div>
                                <label for="celular" class="sr-only">Celular</label>
                                <input type="text" name="celular" id="celular" class="py-3 px-4 block w-full border border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Número de telefone">
                            </div>

                            <div>
                                <label for="hs-about-contacts-1" class="sr-only">Detalhes</label>
                                <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" rows="4" class="py-3 px-4 block w-full border border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Details"></textarea>
                            </div>
                        </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md md:flex md:items-center md:justify-between">
                <div class="md:mr-6 text-center md:text-left">
                    ...
                    <p class="text-gray-700 flex items-center mb-1">
                        <svg class="h-4 w-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm3-9h-6a2 2 0 00-2 2v6a2 2 0 002 2h6a2 2 0 002-2v-6a2 2 0 00-2-2z"></path>
                        </svg>
                        7799999999
                    </p>
                    <p class="text-gray-700 flex items-center mb-1">
                    ...
                    <p class="text-gray-700 flex items-center">
                        <svg class="h-4 w-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 0l7 4 7-4M5 22V11m14 11V3m-7 8h4"></path>
                        </svg>
                        mateus@mateus.com
                    </p>
                </div>
                <div class="mt-4 md:mt-0 flex justify-center md:justify-end">
                    <a href="#" class="text-gray-500 hover:text-blue-500 mr-4">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 11a6 6 0 016-6h4a6 6 0 016 6v1a3 3 0 11-6 0v-1a6 6 0 00-12 0v1a3 3 0 11-6 0v-1a6 6 0 016 6h4a6 6 0 016-6M4 15v1a3 3 0 003 3h6a3 3 0 003-3v-1"></path>
                        </svg>
                    </a>
