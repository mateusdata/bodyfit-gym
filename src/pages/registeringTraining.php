                                ...
                                ?>
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr>
                                            ...
                                            <td class="h-px whitespace-nowrap w-full">
                                                <div class="px-6 py-3">
                                                    <label for="tipoTreino" class="block w-full text-sm font-medium text-gray-700 dark:text-gray-300"></label>
                                                    <select onchange="updateUser('<?= $value['id'] ?>', this.value)" id="tipoTreino" name="tipoTreino" class="mt-1  block w-full px-3 py-2 border rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-gray-500 dark:focus:border-gray-600">
                                                        <option value="<?= $value['tipo_treino'] ?>" selected><?= $value['tipo_treino'] ?></option>
                                                        <option value="treino_iniciante">Treino Iniciante</option>
                                                        <option value="treino_intermediario">Treino Intermediário</option>
